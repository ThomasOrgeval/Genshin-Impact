...
$(document).ready(function ($) {
  ...
  $('input').change(function (e) {
    e.preventDefault();
    var input = $(this);
    $.post('ajax/resources/inventory.php', {
      item: input.attr('id'),
      amount: input.val()
    }, 'html');
  });
...
function costAscension(lvl_min, lvl_max) {
  $.post('ajax/character/ascension.php', {
    lvl_min: lvl_min,
    lvl_max: lvl_max
  }, function (response) {
...
function costTalent(tal_min, tal_max) {
  $.post('ajax/character/talent.php', {
    lvl_min: tal_min,
    lvl_max: tal_max
  }, function (response) {
...
function showCharacterItem(item) {
  if (item.val() === '0') item.parents(':eq(1)').addClass('d-none');else item.parents(':eq(1)').removeClass('d-none');
}

function addQueue(id) {
  var inputs = $('#' + id + ' .item-required :input');
  var ids = $('#' + id + ' .item-have :input');

  for (var i = 0; i < inputs.length; i++) {
    if (number($('#' + inputs[i].id).val()) !== 0) {
      $.post('ajax/character/queue.php', {
        item: ids[i].id,
...
function clearQueue() {
  $.post('ajax/queue/clear.php', function () {
    $('#queue').remove();
  }, 'html');
}

function deleteItemQueue(id) {
  $.post('ajax/queue/delete.php', {
    item: id
  }, 'html');
}
...
/******/ 	__webpack_require__.O(undefined, ["css/black","css/select","css/app"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/black","css/select","css/app"], () => (__webpack_require__("./resources/css/app.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/black","css/select","css/app"], () => (__webpack_require__("./resources/css/select.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/black","css/select","css/app"], () => (__webpack_require__("./resources/css/black.css")))
